...
from .conv_type import SFPConv2d
...
def conv3x3(in_planes, out_planes, stride=1):
    return SFPConv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.fc_mask = nn.Linear(512 * block.expansion, num_classes)
        self.fc_no_mask = nn.Linear(512 * block.expansion, num_classes)

        for m in self.modules():
            if isinstance(m, SFPConv2d):
